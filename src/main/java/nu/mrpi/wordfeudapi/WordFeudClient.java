...
public class WordFeudClient {
    ...
    private WordFeudHttpCommunicator wordFeudHttpCommunicator;

    public WordFeudClient(WordFeudHttpCommunicator wordFeudHttpCommunicator) {
        this.wordFeudHttpCommunicator = wordFeudHttpCommunicator;
    }

    public WordFeudClient() {
        this(new WordFeudHttpCommunicator());
    }
